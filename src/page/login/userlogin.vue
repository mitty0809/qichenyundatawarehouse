<template>
  ...
  <el-form class="login-form" status-icon :rules="loginRules" ref="loginForm" :model="loginForm" label-width="0">
    <el-form-item prop="tenant">
      <el-input id="tenant" size="small" @keyup.enter.native="handleLogin" auto-complete="off"
        v-model="loginForm.tenant" :placeholder="$t('login.tenant')">
      ...
      <el-row :span="24">
        <el-col :span="16">
          <el-input size="small" @keyup.enter.native="handleLogin" :maxlength="code.len" v-model="loginForm.code"
            auto-complete="off" :placeholder="$t('login.code')">
