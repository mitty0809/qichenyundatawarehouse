    ...
    <div class="top-bar__right">
      ...
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item>
              <router-link to="/info/menu">{{$t('navbar.menu')}}</router-link>
          </el-dropdown-item>
          <el-dropdown-item>
              <router-link to="/info/control">{{$t('navbar.control')}}</router-link>
          </el-dropdown-item>
          <el-dropdown-item>
            <router-link to="/info/tenant">{{$t('navbar.tenant')}}</router-link>
        </el-dropdown-item>
        <el-dropdown-item>
            <router-link to="/info/role">{{$t('navbar.role')}}</router-link>
        </el-dropdown-item>
        <el-dropdown-item>
            <router-link to="/info/organization">{{$t('navbar.organization')}}</router-link>
        </el-dropdown-item> -->
