...
// 新增菜单类型为目录
export const getcatalogue = (name,menuType,icon,seq) => request({
...
// 新增菜单类型为菜单
export const getMenu2 = (name,menuType,path,component,keepAlive,icon,seq) => request({
    url: baseUrl + 'open/menu/add',
    method:'post',
    data:{
        name,
...
// 新增按钮
export const getbutton = (parentId,name,menuType,permission,seq) => request({
    url:baseUrl + 'open/menu/add',
    method:'post',
    data:{
        parentId,
...
// 菜单编辑
export const menucompile = (id,parentId,name,menuType,icon,path,component) => request({
...
// 新增角色
export const roleadd =(roleNo,roleName,dataType,remark) => request({
...
// })
// 修改角色信息
export const roleupdate = (id,roleName,dataType,remark) => request({
...
// 获取公告列表
export const noticelist =(searchContent) => request({
